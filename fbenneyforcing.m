function f = fbenneyforcing(t, domain, params)
    ...
    h = 1 - params.a * cos(x - params.c*t) - params.b * cos(y);
    ...
    F1x = 2 * h.^2 .* sx * xsf ...
        - h.^2 .* sx.^2 * xsf^2 * (2 * cot(params.theta) + xsf^2 / params.C) ...
        - h.^3 / 3 .* cx * xsf^2 * (2 * cot(params.theta) + xsf^2 / params.C) ...
        + 16 * params.Re / 5 * h.^5 .* sx.^2 * xsf^2 ...
        + 8 * params.Re / 15 * h.^6 .* cx * xsf^2;

    F2y = - h.^2 .* sy.^2 * ysf^2 * (2 * cot(params.theta) + ysf^2 / params.C) ...
        - h.^3 / 3 .* cy * ysf^2 * (2 * cot(params.theta) + ysf^2 / params.C);
