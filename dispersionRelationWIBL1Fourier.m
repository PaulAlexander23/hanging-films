function omega = dispersionRelationWIBL1Fourier(domain, hbar, F1bar, F2bar, params, alpha, modes)
    ...
    for n = 1:length(alpha)
        A = linearisedWIBL1Fourier(domain, hbar, F1bar, F2bar, params, alpha(n));
        ...
        %val = val(logical(zeroVolumeIndices.*zeroFlux1Indices.*zeroFlux2Indices));
