function y0 = iloadProfileEigWIBL2STF(x, filename, perturabtionAmplitude, params)
    ...
    eigF = real(eigenfunctionWIBL2STF(domain, h0(1,:).', f10(1,:).', f20(1,:).', params, 2*pi/x{1}(end)));
