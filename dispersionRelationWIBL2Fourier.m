function omega = dispersionRelationWIBL2Fourier(domain, hbar, F1bar, F2bar, params, alpha, modes)
    ...
    for n = 1:length(alpha)
        A = linearisedWIBL2Fourier(domain, hbar, F1bar, F2bar, params, alpha(n));
